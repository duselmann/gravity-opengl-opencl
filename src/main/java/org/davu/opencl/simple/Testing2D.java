...
//      PointerBuffer device = getMaxComputeUnitDevicePlatform(platformsDevices);
        ...
        String source = loadResourceString("cl/sum2D.txt");
        ...
        int cols = 6;
        int rows = 4;
        pushKernelToQueue(queue, kernel, cols, rows);
